...
movie = pd.read_csv('odev_recommender_systems/HYBRID_RECOMMENDER_PROJECT/datasets/movie.csv')
movie.head()
movie.shape

# UserID, film adı, filme verilen oy ve zaman bilgisini içeren veri seti
rating = pd.read_csv('odev_recommender_systems/HYBRID_RECOMMENDER_PROJECT/datasets/rating.csv')
rating.head()
rating.shape
...
#boş olmayanların isimlerini getirir
